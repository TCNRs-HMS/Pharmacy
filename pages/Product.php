...
<div class="container-fluid bg-primary p-3">
    ...
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 pb-3">                 
        <ul class="navbar-nav mx-auto">
            ...
            <li><a href="#" class="nav-item nav-link active">Products</a></li>
                    ...
                    <div class="card-body">
                        <table class="table table-bordered text-center">
                            ...
                            <?php 
                                ...
                                <td><img src="http://localhost/Pharmacy-Website/images/<?php echo $row['Category'] . '/' . $row['Image']; ?>" style="width: 25%;" height="50px" alt=""><?php echo $row['Image']; ?></td>                                
